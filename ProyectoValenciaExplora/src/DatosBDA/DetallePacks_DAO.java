...
public class DetallePacks_DAO {
    ...
    public void insertarDetallePack(Connection conexion, ArrayList<DetallePacks> lista_detalle) throws Exception {
        ...
        for (int i = 0; i < lista_detalle.size(); i++) {
            ...
            Timestamp fechaInicio = java.sql.Timestamp.valueOf(lista_detalle.get(i).getFechaInicio());
            Timestamp fechaFin = java.sql.Timestamp.valueOf(lista_detalle.get(i).getFechaFin());
            ...
            ps.setTimestamp(6, fechaInicio);
            ps.setTimestamp(7, fechaFin);
